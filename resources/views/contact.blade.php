        ...
        <div class="row contact-page-wrapper">
          <div class="col-lg-12">
            <div class="contact-info-wrap">
              <div class="info-item">
                <div class="icon">
                  <img src="assets/img/icons/c1.webp" alt="Image" width="42" height="42">
                </div>
                <div class="info">
              ...
              <div class="info-item">
                <div class="icon">
                  <img src="assets/img/icons/c2.webp" alt="Image" width="43" height="73">
                </div>
                <div class="info">
              ...
              <div class="info-item">
                <div class="icon">
                  <img src="assets/img/icons/c3.webp" alt="Image" width="36" height="46">
                </div>
                <div class="info">
