        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
            ...
            <div class="team-item">
              <div class="thumb">
                <a href="candidate-details.blade.php">
                  <img src="assets/img/team/5.webp" width="160" height="160" alt="Image-HasTech">
                </a>
              </div>
              <div class="content">
                <h4 class="title"><a href="candidate-details.blade.php">David Silva</a></h4>
                <h5 class="sub-title">Web Designer</h5>
                <div class="rating-box">
                  <i class="icofont-star"></i>
                  <i class="icofont-star"></i>
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
            ...
            <div class="team-item">
              <div class="thumb">
                <a href="candidate-details.blade.php">
                  <img src="assets/img/team/6.webp" width="160" height="160" alt="Image-HasTech">
                </a>
              </div>
              <div class="content">
                <h4 class="title"><a href="candidate-details.blade.php">Jason Holt</a></h4>
                <h5 class="sub-title">UI/UX Designer</h5>
                <div class="rating-box">
                  <i class="icofont-star"></i>
                  <i class="icofont-star"></i>
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
            ...
            <div class="team-item">
              <div class="thumb">
                <a href="candidate-details.blade.php">
                  <img src="assets/img/team/7.webp" width="160" height="160" alt="Image-HasTech">
                </a>
              </div>
              <div class="content">
                <h4 class="title"><a href="candidate-details.blade.php">Elnora Morton</a></h4>
                <h5 class="sub-title">App. Developer</h5>
                <div class="rating-box">
                  <i class="icofont-star"></i>
                  <i class="icofont-star"></i>
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
            ...
            <div class="team-item">
              <div class="thumb">
                <a href="candidate-details.blade.php">
                  <img src="assets/img/team/8.webp" width="160" height="160" alt="Image-HasTech">
                </a>
              </div>
              <div class="content">
                <h4 class="title"><a href="candidate-details.blade.php">Leona Spencer</a></h4>
                <h5 class="sub-title">UI/UX Designer</h5>
                <div class="rating-box">
                  <i class="icofont-star"></i>
                  <i class="icofont-star"></i>
            ...
            <div class="pagination-area">
              <nav>
                <ul class="page-numbers d-inline-flex">
                  <li>
                    <a class="page-number active" href="candidate.blade.php">1</a>
                  </li>
                  <li>
                    <a class="page-number" href="candidate.blade.php">2</a>
                  </li>
                  <li>
                    <a class="page-number" href="candidate.blade.php">3</a>
                  </li>
                  <li>
                    <a class="page-number next" href="candidate.blade.php">
